#undef ABILITYSYSTEM2_API
#undef ABILITYSYSTEM2_VTABLE
...
#define UE_PROJECT_NAME AbilitySystem2
...
#define ABILITYSYSTEM2_VTABLE DLLEXPORT_VTABLE
#define ABILITYSYSTEM2_API DLLEXPORT
